...
public class Fuzzy_rules : MonoBehaviour
{
    ...
    private void Rules()
    {
        ...
        if ((l.To_target == "РОВНО") && (l.Distance_front == "ДАЛЕКО") && (l.Dist_to_target == "ДАЛЕКО")) { l.Speed = "БЫСТРО"; }
            ...
            if ((l.To_target == "РОВНО") && (l.Distance_front == "БЛИЗКО") && ((l.Distance_right == "ДАЛЕКО") || ((l.Distance_right == "СРЕДНЕ")))) { l.Degree = "ПРАВЕЕ"; }
            ...
            if (((l.To_target == "ЛЕВЕЕ") || (l.To_target == "СИЛЬНО ЛЕВЕЕ")) && ((l.Distance_left == "ДАЛЕКО") || (l.Distance_left == "СРЕДНЕ"))) { l.Degree = "ЛЕВЕЕ"; }
            if (((l.To_target == "ПРАВЕЕ") || (l.To_target == "СИЛЬНО ПРАВЕЕ")) && ((l.Distance_right == "ДАЛЕКО") || (l.Distance_right == "СРЕДНЕ"))) { l.Degree = "ПРАВЕЕ"; }
